...
const Sidebar = ({handleSlide}) => {
  ...
  return (
    <>
      <aside 
        id="sidebar" 
        className={`z-20 w-[230px] shadow-md xs:w-[250px] absolute h-[100%] top-0 overflow-y-auto bg-white -translate-x-full lg:block lg:translate-x-0 transition duration-200 ease-in-out flex-shrink-0 `}
      >
