      ...
      <div className="w-[85%] h-[100vh] mx-auto p-0 m-0 flex flex-row">
        ...
        <div className="w-[50%] flex align-center justify-center">
          <div className="w-[80%] flex flex-col justify-center">
            ...
            <input className={`w-full p-3 m-4 mt-1 border-2 bg-slate-100 ${passwordStatus === "" ? "border-primary":"border-lightRed"} rounded-xl focus:ring-2 outline-none`} type="password" placeholder='******' value={confirmPassword} onChange={handleChangeConfirmPassword}/>
            <div className="mb-5 ml-1 inline-flex items-center relative">
              ...
              <span className="text-blue">Do you agreee with our policy?</span>
            </div>
            <div className="mt-10 flex flex-col align-center justify-center items-center">
              <button onClick={handleSubmit}>
                <PrimaryButton  text="Sign Up" />
              </button>
              <p className="p-5 text-xl text-blue">Already User?&nbsp;&nbsp;<Link to={"/login"} className="underline underline-offset-8">Sign In</Link></p>
            </div>
          </div>
        </div>
      </div>
